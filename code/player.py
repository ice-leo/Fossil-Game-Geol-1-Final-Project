...
class Player(Entity):
    ...
    def __init__(self, pos, groups, obstacle_sprites, interact_callback):
        ...
        raw = pygame.image.load(resource_path('graphics/player/down/0.png')).convert_alpha() \
              if self._art_exists(resource_path('graphics/player/down/0.png')) \
    ...
    def _import_assets(self):
        ...
        for anim in self.animations:
            path = resource_path(f'{base}/{anim}')
