...
class ExcavationGame:
    def __init__(self, return_callback):
        ...
        self.img_soil = pygame.image.load(resource_path('graphics/excavation/interface/soil.png')).convert_alpha()
        self.img_rock = pygame.image.load(resource_path('graphics/excavation/interface/rock.png')).convert_alpha()
        self.img_frame = pygame.image.load(resource_path('graphics/excavation/interface/excavation_frame.png')).convert_alpha()
        self.img_cursor = pygame.image.load(resource_path('graphics/excavation/cursor/pickaxe.png')).convert_alpha()
        
        self.fossil_images = []
        for i in range(1, 7):
            surf = pygame.image.load(resource_path(f'graphics/excavation/fossils/fossil{i}.png')).convert_alpha()
            self.fossil_images.append(surf)

        JOYSTIX = resource_path('graphics/font/joystix.ttf')
        self.font = pygame.font.Font(JOYSTIX, 30)
        self.small_font = pygame.font.Font(JOYSTIX, 20)
    ...
    def draw(self):
        ...
        self.display_surface.blit(text_surf, (50, 25))
