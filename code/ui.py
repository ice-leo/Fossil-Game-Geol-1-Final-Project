...
class UI:
    ...
    def __init__(self):
        ...
        self.font_large  = pygame.font.Font(JOYSTIX, 20)
        self.font_medium = pygame.font.Font(JOYSTIX, 16)
        self.font_small  = pygame.font.Font(JOYSTIX, 12)
    ...
    def _draw_score(self, points: int):
        ...
        self.display_surface.blit(label, label.get_rect(center=bg.center))
    ...
    def _draw_fossildex_button(self):
        ...
        label = self.font_small.render('FossilDex (F)', True, TEXT_COLOR)
    ...
    def _draw_game_progress(self, exc_levels_done: list, quiz_done: bool):
        ...
        for lvl in range(1, 4):
            ...
            color = "#001eff" if done else "#242222"
        ...
        color = "#001eff" if quiz_done else "#242222"
        label = self.font_small.render(
