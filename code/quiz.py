...
class QuizGame:
    def __init__(self, level_ref, return_callback):
        ...
        # ── Load Graphics ────────────────────────────────────────────────────
        self.img_cursor = pygame.image.load(resource_path('graphics/quiz/cursor/cursor.png')).convert_alpha()
        self.img_qscore = pygame.image.load(resource_path('graphics/quiz/end/qscore.png')).convert_alpha()
        self.img_trophy = pygame.image.load(resource_path('graphics/quiz/end/trophy.png')).convert_alpha()
        ...
        for i in range(len(QUIZ_QUESTIONS)):
            ...
            surf = pygame.image.load(resource_path(f'graphics/quiz/questions/q{i+1}.png')).convert_alpha()
